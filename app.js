...
// --- Add Event Listeners ---
// Note: Inline onclick="" attributes (jo HTML mein thay) ko hata diya gaya hai 
// aur unki jagah yeh professional tareeqa istemal kiya gaya hai.
processBtn.addEventListener('click', processImage);
downloadBtn.addEventListener('click', downloadTransformedImage);
downloadIconBtn.addEventListener('click', downloadTransformedImage);
